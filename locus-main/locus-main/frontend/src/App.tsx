  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 relative overflow-hidden bg-slate-50">
      ...
      <main className="w-full max-w-md z-10 space-y-8">
        ...
        {/* Link to Resident App (20251213-master) */}
        {(userAddress) && (
          <div className="text-center">
            <a
              href="http://localhost:5174"
              className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-purple-600 to-blue-600 text-white font-bold rounded-xl shadow-lg hover:shadow-xl hover:scale-105 transition-all"
            >
              <Wallet className="w-5 h-5" />
              住民票アプリへ移動
            </a>
            <p className="text-xs text-slate-500 mt-2">※別タブで開きます</p>
          </div>
        )}
